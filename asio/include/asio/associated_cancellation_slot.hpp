...
struct associated_cancellation_slot_impl<T, E,
  typename void_type<typename T::cancellation_slot_type>::type>
{
...
struct associated_cancellation_slot_impl<T, E,
  typename enable_if<
    ...
    typename associator<associated_cancellation_slot, T, E>::type
  >::type> : associator<associated_cancellation_slot, T, E>
{
};
...
#endif // !defined(GENERATING_DOCUMENTATION)
{
  ...
  /// <tt>t.get_cancellation_slot()</tt>. Otherwise returns @c ex.
  static type get(const T& t,
      const CancellationSlot& ex = CancellationSlot()) ASIO_NOEXCEPT;
#endif // defined(GENERATING_DOCUMENTATION)
};
...
template <typename T, typename E>
struct associated_cancellation_slot_forwarding_base<T, E,
    typename enable_if<
      is_same<
        typename associated_cancellation_slot<T,
          E>::asio_associated_cancellation_slot_is_unspecialised,
        void
      >::value
    >::type>
{
